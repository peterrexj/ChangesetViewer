...
namespace PeterRexJoseph.ChangesetViewer
{
    ...
    [ProvideOptionPage(typeof(SettingsPageModel), Consts.Pluginname, Consts.SettingspageServer, 0, 0, true)]
    ...
    public sealed class ChangesetViewerPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidChangesetViewerCmdSet, (int)PkgCmdIDList.cmdidViewChangeset);
                MenuCommand menuItem = new MenuCommand(MenuItemCallback, menuCommandID );
                mcs.AddCommand( menuItem );
                // Create the command for the tool window
                CommandID toolwndCommandID = new CommandID(GuidList.guidChangesetViewerCmdSet, (int)PkgCmdIDList.cmdidChangesetViewer);
