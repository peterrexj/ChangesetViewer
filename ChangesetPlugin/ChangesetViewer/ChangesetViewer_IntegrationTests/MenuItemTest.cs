...
namespace ChangesetViewer_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(PeterRexJoseph.ChangesetViewer.GuidList.guidChangesetViewerCmdSet, (int)PeterRexJoseph.ChangesetViewer.PkgCmdIDList.cmdidViewChangeset);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ChangesetViewer", "PeterRexJoseph.ChangesetViewer.ChangesetViewerPackage");
