...
using PeterRexJoseph.ChangesetViewer;

namespace ChangesetViewer_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new ChangesetViewerPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(PeterRexJoseph.ChangesetViewer.GuidList.guidChangesetViewerCmdSet, (int)PeterRexJoseph.ChangesetViewer.PkgCmdIDList.cmdidViewChangeset);
