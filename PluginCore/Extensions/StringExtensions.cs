...
namespace PluginCore.Extensions
{
	public static class StringExtensions
	{
		...
		/// <summary>
		/// return mvc fileContentResult from string
		/// </summary>
		/// <param name="s"></param>
		/// <param name="contentType">contentType of file to be returned eg text/html</param>
		/// <param name="name">name of file to be returned eg test.htm</param>
		/// <returns></returns>
        //public static System.Web.Mvc.FileContentResult ToFileResult(this string s, string contentType, string name)
        //{
        //    var bytes = System.Text.Encoding.UTF8.GetBytes(s);
        //    var result = new System.Web.Mvc.FileContentResult(bytes, contentType);
		...
		{
			//(IS) had to fix a bug for a case when guidStr was null
	...
	{
		/// <summary>
		/// (IS) safe (null aware) version of String.Length
		/// </summary>
		...
		/// <summary>
		/// (IS) safe version of String.Remove
		/// </summary>
		...
		/// <summary>
		/// (IS) removes the strToTrim string from the lhs of the given string; the value is returned untouched if it doesnt start with the strToTrim string.
		/// </summary>
		...
		/// <summary>
		/// (IS) removes the strToTrim string from the rhs of the given string; the value is returned untouched if it doesnt end with the strToTrim string.
		/// </summary>
		...
		/// <summary>
		/// (IS) null-aware version of ToString()
		/// </summary>
		...
		/// <summary>
		/// (IS) safe (null-aware) version of String.Replace
		/// </summary>
		...
		/// <summary>
		/// (IS) null-aware String.StartsWith()
		/// </summary>
		...
		/// <summary>
		/// <para>(IS) Shortcut for !String.IsNullOrEmpty()</para>
		...
		/// <summary>
		/// <para>(IS) Concatenates a and b using the separator in between if both a and b arent empty; otherwise just the result of a + b</para>
		/// <para>*expandable</para>
		/// </summary>
		...
		/// <summary>
		/// (IS) Returns null if the value is an empty string or null, otherwise - the given value
		/// </summary>
		/// <param name="value">this string</param>
		...
		/// <summary>
		/// <para>(IS) checks if this string has a value, and if so returns this string value, otherwise - the alternative altValue</para>
		/// <para>*expandable</para>
		/// </summary>
		/// <param name="value">this string</param>
		...
		/// <summary>
		/// (IS) checks if this string has a value, and if so returns this string value, otherwise - the alternative altValue
		/// </summary>
		/// <param name="value">this string</param>
		/// <param name="altValue">alternative value to return if this string is null or empty</param>
		/// <returns>this string value if it is not empty, otherwise - the alternative altValue</returns>
		...
		/// <summary>
		/// (IS) Returns true if this string matches the other - case-insensitive
		/// </summary>
		/// <param name="value">this string</param>
		...
		/// <summary>
		/// (IS) Returns parts of the given value separated with the given separator. Empty items are excluded if excludeEmptyParts is true.
		/// </summary>
		...
		/// <summary>
		/// (IS) Returns parts of the given value separated with the given separator. Empty items are excluded.
		/// </summary>
		/// <param name="value">the value for which the parts are calculated</param>
		/// <param name="separator">separator which separates the parts in the given value</param>
		/// <returns>seq of parts within the given value</returns>
		...
		/// <summary>
		/// (IS) null-aware version of String.Contains(string)
		/// </summary>
		/// <param name="value">this string</param>
		...
		/// <summary>
		/// (IS) converts ABC to aBC - or original value if its length is less than 1
		/// </summary>
		...
		/// <summary>
		/// <para>(IS) surrounds the given value with 'left' value on the left and 'right' value on the right, if the value isnt blank, in which case it returns the empty value</para>
		/// <para>*expandable</para>
		/// </summary>
		...
		/// <summary>
		/// <para>(IS) returns true if the character at the given position in the string is a number</para>
		/// <para>*expandable</para>
		/// </summary>
		...
		{
			//(IS) handling blank baseId parameter
			if (!src.HasValue())
				return src;
		...
		/// <summary>
		/// (IS) changes the first character of the given string to the upper case
		/// </summary>
        ...
        /// <summary>
        /// <para>(IS) returns hash value for the given string which uniquely identifies it: hashes of two sets of data should match if and only if the corresponding data also matches.</para>
        ...
        /// <returns>
        /// <para>hash value for the given string which uniquely identifies it: hashes of two sets of data should match if and only if the corresponding data also matches.</para>
		...
		/// <returns></returns>
		public static string ByteSizeToHumanString(this long size)
		{
			var sizes = new[] { "B", "kB", "MB", "GB", "TB" };
			int order = 0;
            double sizeFloat = size;
            while (sizeFloat >= 1000 && order + 1 < sizes.Length)
			{
				order++;
    ...
    //        public static readonly Expression<Func<string, bool>> HasValue = (v) => !string.IsNullOrEmpty(v);
    //        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes")]
    //        public static readonly Expression<Func<string, string, string, string>> ConcatWithSeparator = (a, b, separator) => a.HasValue() && b.HasValue() ? a + separator + b : a + b;
    //        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes")]
    //        public static readonly Expression<Func<string, string, string>> Alt = (value, altValue) => value.HasValue() ? value : altValue;
    //        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes")]
    //        public static readonly Expression<Func<string, string, string, string>> Surround = (value, left, right) => value.HasValue() ? left + value + right : value;
    //        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes")]
    //        public static readonly Expression<Func<string, int, bool>> IsNumberCharAt = (value, index) => SqlFunctions.IsNumeric(value.Substring(index, 1)) == 1;
    //    }
    //}
}
